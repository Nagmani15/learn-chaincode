...
//						 user's eCert
//==============================================================================================================================
//CURRENT WORKAROUND USES ROLES CHANGE WHEN OWN USERS CAN BE CREATED SO THAT IT READ 1, 2, 3
const   DEFAULT_MONEY      =  "defaultmoney"
const   SENDER   =  "sender"
...
//==============================================================================================================================
//	 Status types - payment lifecycle is broken down into 3 statuses, this is part of the business logic to determine what can
//					be done to the payment at points in it's lifecycle
//==============================================================================================================================
const   STATE_MONEY  			=  0
const   STATE_SENDER  			=  1
const   STATE_RECIEVER 	=  2
...
//==============================================================================================================================
//	PAYMENT - Defines the structure for a car object. JSON on right tells it what JSON fields to map to
